...
const DOMAIN_NAME = 'damo.icu' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    repo: 'shamoasis/vuepress-theme-vdoing', // 导航栏右侧生成Github链接
    searchMaxSuggestions: 10, // 搜索结果显示最大数
    lastUpdated: '上次更新', // 开启更新时间，并配置前缀文字   string | boolean (取值为git提交时间)
    docsDir: 'docs', // 编辑的文件夹
    docsBranch: 'ghpages', // 编辑的文件所在分支，默认master。 注意：如果你的分支是main则修改为main
    editLinks: true, // 启用编辑
    editLinkText: '编辑',
    ...
    author: {
      name: '大漠', // 必需
      link: 'https://github.com/shamoasis', // 可选的
    },
  ...
  head: [
    ...
    [
      ...
      {
        name: 'keywords',
        content: '后端博客,个人技术博客,后端,后端开发,云原生,Spring,SpringCloud,技术文档,学习,面试,Java,Spring,SpringBoot,SpringCloud,python,Rust,git,github,markdown',
      },
    ],
    ['meta', { name: 'referrer', content: 'no-referrer-when-downgrade' }],
    ['link', { rel: 'stylesheet', href: 'https://at.alicdn.com/t/font_3077305_pt8umhrn4k9.css' }],// 站点信息5各图标
    ['meta', { name: 'baidu-site-verification', content: 'code-lZueDnbbB6' }], // 百度统计的站长验证（你可以去掉）
